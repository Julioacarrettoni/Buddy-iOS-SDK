...
- (void)Sound_Sounds_GetSound:(NSString *)SoundName Quality:(NSString *)Quality state:(NSObject *)state callback:(void (^)(BuddyCallbackParams * callbackParams, id jsonArray))callback;
